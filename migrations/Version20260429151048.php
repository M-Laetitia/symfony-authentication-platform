 ...
 */
final class Version20260429151048 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, category_id INT DEFAULT NULL, title VARCHAR(150) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(150) NOT NULL, status VARCHAR(255) NOT NULL, content JSON DEFAULT NULL, excerpt VARCHAR(160) DEFAULT NULL, meta_title VARCHAR(60) NOT NULL, meta_description VARCHAR(160) DEFAULT NULL, is_featured TINYINT(1) DEFAULT NULL, introduction LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), INDEX IDX_23A0E66F675F31B (author_id), INDEX IDX_23A0E6612469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE conversation_report (id INT AUTO_INCREMENT NOT NULL, reported_by_id INT NOT NULL, conversation_id INT NOT NULL, reason VARCHAR(255) DEFAULT NULL, message_reference VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', admin_notes VARCHAR(255) DEFAULT NULL, status LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', INDEX IDX_F6E3CD4471CE806 (reported_by_id), INDEX IDX_F6E3CD449AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gallery_series (id INT AUTO_INCREMENT NOT NULL, photographer_id INT DEFAULT NULL, name VARCHAR(125) NOT NULL, type VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_9893ED8F53EC1A21 (photographer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, photographer_id INT DEFAULT NULL, gallery_series_id INT DEFAULT NULL, path VARCHAR(255) NOT NULL, alt_text VARCHAR(150) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', type_image VARCHAR(255) NOT NULL, caption LONGTEXT DEFAULT NULL, width VARCHAR(5) DEFAULT NULL, height VARCHAR(5) DEFAULT NULL, title VARCHAR(80) DEFAULT NULL, INDEX IDX_6A2CA10C7294869C (article_id), INDEX IDX_6A2CA10C53EC1A21 (photographer_id), INDEX IDX_6A2CA10CEFED64A (gallery_series_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, service_proposal_id INT NOT NULL, client_id INT NOT NULL, order_number VARCHAR(30) NOT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', service_snapshot JSON NOT NULL, terms_accepted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', note LONGTEXT DEFAULT NULL, total_amount INT NOT NULL, UNIQUE INDEX UNIQ_F5299398551F0F81 (order_number), INDEX IDX_F529939838E306F4 (service_proposal_id), INDEX IDX_F529939819EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE photographer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, first_name VARCHAR(30) DEFAULT NULL, last_name VARCHAR(30) DEFAULT NULL, slug VARCHAR(150) NOT NULL, email VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', profile JSON DEFAULT NULL, status LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', visibility LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', UNIQUE INDEX UNIQ_16337A7F989D9B62 (slug), UNIQUE INDEX UNIQ_16337A7FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE photographer_speciality (photographer_id INT NOT NULL, speciality_id INT NOT NULL, INDEX IDX_B145272953EC1A21 (photographer_id), INDEX IDX_B14527293B5A08D7 (speciality_id), PRIMARY KEY(photographer_id, speciality_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reset_password_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expires_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service_proposal (id INT AUTO_INCREMENT NOT NULL, photographer_id INT NOT NULL, client_id INT NOT NULL, conversation_id INT NOT NULL, tax_id INT NOT NULL, speciality_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', expiration_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status VARCHAR(255) NOT NULL, price_exclu_tax NUMERIC(10, 2) NOT NULL, delivery_delay INT NOT NULL, edited_photo_count INT NOT NULL, start_at TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\', end_at TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\', service_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', location VARCHAR(255) NOT NULL, INDEX IDX_4693CF4F53EC1A21 (photographer_id), INDEX IDX_4693CF4F19EB6921 (client_id), INDEX IDX_4693CF4F9AC0396 (conversation_id), INDEX IDX_4693CF4FB2A824D8 (tax_id), INDEX IDX_4693CF4F3B5A08D7 (speciality_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE speciality (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(20) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE gallery_series ADD CONSTRAINT FK_9893ED8F53EC1A21 FOREIGN KEY (photographer_id) REFERENCES photographer (id)');
        ...
        $this->addSql('ALTER TABLE media ADD CONSTRAINT FK_6A2CA10CEFED64A FOREIGN KEY (gallery_series_id) REFERENCES gallery_series (id)');
        ...
        $this->addSql('ALTER TABLE photographer_speciality ADD CONSTRAINT FK_B145272953EC1A21 FOREIGN KEY (photographer_id) REFERENCES photographer (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE photographer_speciality ADD CONSTRAINT FK_B14527293B5A08D7 FOREIGN KEY (speciality_id) REFERENCES speciality (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE service_proposal ADD CONSTRAINT FK_4693CF4F3B5A08D7 FOREIGN KEY (speciality_id) REFERENCES speciality (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery_series DROP FOREIGN KEY FK_9893ED8F53EC1A21');
        ...
        $this->addSql('ALTER TABLE media DROP FOREIGN KEY FK_6A2CA10CEFED64A');
        ...
        $this->addSql('ALTER TABLE photographer_speciality DROP FOREIGN KEY FK_B145272953EC1A21');
        $this->addSql('ALTER TABLE photographer_speciality DROP FOREIGN KEY FK_B14527293B5A08D7');
        ...
        $this->addSql('DROP TABLE gallery_series');
        ...
        $this->addSql('DROP TABLE photographer_speciality');
